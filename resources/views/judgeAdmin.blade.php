...
@section('title', 'ADHIZ - Judges Admin')
                ...
                <table id="tableDataJudge" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$showData[$i]->total}} / 17 Peserta</td>
                            <td class=" dt-center align-middle">
                                <div class="align-middle" style="width: 100px;">
                                    <div class="col">
                                        <a href="{{ url('detail-judge-admin')}}/{{$showData[$i]->id_judge}}" class="btn btn-primary btn-sm px-2" style="font-size: 12px; width: 70px;">Detail</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
