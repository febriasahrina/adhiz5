                        ...
                        <div class="row m-l-0 m-r-0">
                            ...
                            <div class="col-sm-12">
                                <div class="card-block">   
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <h6 class="m-b-20 p-b-5 b-b-default f-w-600 pt-5">Tim</h6>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <p class="m-b-10 f-w-600">Nama Tim</p>
                                                    <h6 class="text-muted f-w-400 pb-1" id="judul-ide">{{$showData[0]->nama_tim}}</h6>
                                                </div>
                                                <div class="col-sm-12">
                                                    <p class="m-b-10 f-w-600">Judul Ide</p>
                                                    <h6 class="text-muted f-w-400 pb-1" id="judul-ide">{{$showData[0]->judul_ide}}</h6>
                                                </div>
                                                <div class="col-sm-12">
                                                    <p class="m-b-10 f-w-600">Deskripsi</p>
                                                    <h6 class="text-muted f-w-400 pb-1" id="deskripsi-ide">{{$showData[0]->deskripsi}}</h6>
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-sm-8">                                                               
                                            ...
                                            <?php
                                                $path = "{{asset('files/')}}/{{$showData[0]->email}}.pptx";
                                                if(count($showData)>0)
                                                {
                                                    for($i=0; $i<count($showData); $i++)
                                                    {
                                                        $emailFile = $showData[0]->email;
                                            ?>
                                            <div class="row">
                                                <div class="col-sm-1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600 pt-5">File Materi</h6>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <h6 class="text-muted f-w-400 pb-4" id="file-pdf"><a id="file-pdf-a" href='{{asset('files/')}}/{{$showData[0]->email}}.pptx' role="button" target="_blank">file.pptx</a></h6>
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600 pt-5">File Video</h6>
                                            <div class="row">
                                                <div class="col-sm-12">
